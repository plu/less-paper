...
`docs/superpowers/specs/2026-08-08-bulk-edit-ui-design.md` shipped bulk edit for correspondent, document type and storage path, and explicitly deferred tags:
...
- `BulkEditDocumentsInput.Method.modifyTags(ModifyTags)` with `addTags: [Tag.Id]` / `removeTags: [Tag.Id]`, encoding to `{"method": "modify_tags", "parameters": {"add_tags": […], "remove_tags": […]}}` (`docs/superpowers/specs/2026-08-08-bulk-edit-api-design.md`)
- `GetSelectionDataOutput.selectedTags: [SelectionDataItem<Tag.Id>]` (`docs/superpowers/specs/2026-08-08-selection-data-api-design.md`)
