...
The project is generated by [Tuist](https://tuist.dev) from `Project.swift`, and split into 50 modules declared in `Tuist/ProjectDescriptionHelpers/Module.swift`:
