...
**Design doc:** `docs/superpowers/specs/2026-08-21-api-version-negotiation-design.md`
...
(`docs/superpowers/specs/2026-08-09-docker-seed-data-design.md`). Pin an older paperless-ngx image there — one whose
