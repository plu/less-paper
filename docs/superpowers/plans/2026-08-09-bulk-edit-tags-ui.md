...
**Full design context:** See `docs/superpowers/specs/2026-08-09-bulk-edit-tags-ui-design.md` for the investigation and rationale — this plan implements that design directly. The preceding phase is `docs/superpowers/specs/2026-08-08-bulk-edit-ui-design.md` / `-plan.md`; every pattern below is lifted from what it shipped.
