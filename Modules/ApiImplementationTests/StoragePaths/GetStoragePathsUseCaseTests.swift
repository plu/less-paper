...
@Suite
struct GetStoragePathsUseCaseTests {
    ...
    func execute() async throws {
        ...
        try await withDependencies {
            $0.storagePathsRepository.getStoragePaths = { input, _ in
            ...
            let useCase = GetStoragePathsUseCase.liveValue
    ...
    private var cache: IdentifiedArrayOf<ApiInterface.StoragePath> = []
}
