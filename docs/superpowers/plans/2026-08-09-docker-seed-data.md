...
**Full design context:** See `docs/superpowers/specs/2026-08-09-docker-seed-data-design.md`. This plan implements that design directly.
...
Checked against `docs/superpowers/specs/2026-08-09-docker-seed-data-design.md`:
