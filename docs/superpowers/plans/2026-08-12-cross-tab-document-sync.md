...
Full design rationale: `docs/superpowers/specs/2026-08-12-cross-tab-document-sync-design.md`.
...
- Modify: `docs/superpowers/specs/2026-08-12-cross-tab-document-sync-design.md`
...
In `docs/superpowers/specs/2026-08-12-cross-tab-document-sync-design.md`, under `## Testing`, replace the paragraph beginning "The test that actually pins the feature down is a new cross-tab one in `Modules/AppFeatureTests`" with:
...
git add Modules/DocumentsFeatureTests/CrossTabDocumentSyncTests.swift \
        docs/superpowers/specs/2026-08-12-cross-tab-document-sync-design.md
