...
**Full design context:** See `docs/superpowers/specs/2026-08-08-bulk-edit-api-design.md` for the investigation and rationale behind every decision below — this plan implements that design directly.
