...
**Full design context:** See `docs/superpowers/specs/2026-08-08-selection-data-api-design.md` for the investigation and rationale — this plan implements that design directly.
